	...
	return (
		<div className={search.tracksWrapper}>
			...
			<div className="trackRowWrapper">
				...
				>
					{tracks.map((track,index)=> {
						return(<div className="trackRow" key={index}>
							<CustomAudioWave track={track} handleFooterTrack={handleFooterTrack} footer={false}/>
							<div className="rowParticipant duration">
				...
				{/* <InfiniteScroll
					dataLength={props.tracks.length} //This is important field to render the next data
					next={fetchData}
					hasMore={true}
