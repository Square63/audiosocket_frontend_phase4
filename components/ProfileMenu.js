...
function ProfileMenu() {
  ...
  return (
    <ul className={user.userNav}>
      ...
      <li className={router.pathname.toLowerCase() === "/user/billing" ? "billing selected" : "billing"}>
        <Link href="/user/billing">
          <a>
            <span className="desktopShow">Billing</span>
            <svg className="mobileShow"  xmlns="http://www.w3.org/2000/svg" width="192" height="192" fill="#000000" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><rect className={user.reactBilling} x="16" y="64" width="224" height="128" rx="8" fill="none" stroke="#ffffff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"></rect><circle cx="128" cy="128" r="32" fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"></circle><line x1="176" y1="64" x2="240" y2="120" fill="none" stroke="#ffffff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"></line><line x1="176" y1="192" x2="240" y2="136" fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"></line><line x1="80" y1="64" x2="16" y2="120" fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"></line><line x1="80" y1="192" x2="16" y2="136" fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"></line></svg>
          </a>
        </Link>
      </li>
    </ul>
